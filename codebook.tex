...
\fancyhead[L]{National Taiwan Ocean University YHY\_Team}
\fancyhead[R]{\thepage}
...
\lstinputlisting{basic/stringstream.cpp}
...
\subsection{Compare}
\lstinputlisting{basic/compare.cpp}
...
\lstinputlisting{flow/FlowConclusion.txt}

\section{Math}

\subsection{Fast power}
\lstinputlisting{others/fast_power.cpp}
...
\lstinputlisting{math/inv_fac.cpp}
...
\lstinputlisting{graph/trajan.cpp}
...
\lstinputlisting{graph/tree_flatten.cpp}
...
\lstinputlisting{dataStructure/bin_idx_tree.cpp}
...
\lstinputlisting{dataStructure/pers_seg_tree.cpp}

\subsection{SQRT-Decomposition}
\lstinputlisting{dataStructure/sqrt_dec.cpp}
...
\subsection{knapsack}
\lstinputlisting{dp/0_1_problem.cpp}

\subsection{Knapsack Unlimited}
\lstinputlisting{dp/unlimited_knapsack.cpp}

\subsection{Knapsack Limited}
\lstinputlisting{dp/limited_knapsack.cpp}

\subsection{DP on DAG}
\lstinputlisting{dp/dp_on_dag.cpp}

\subsection{LIS}
\lstinputlisting{dp/lis.cpp}

\subsection{Matrix Fast Power}
\lstinputlisting{dp/matrix_fast_power.cpp}

\section{Others}

\subsection{Mo's Algorithm}
\lstinputlisting{others/mos.cpp}

\subsection{Reverse Pair}
\lstinputlisting{others/reverse_pair.cpp}

%\includegraphics[scale=1]{graph/Image7628.gif}
